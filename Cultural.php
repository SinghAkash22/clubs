...
<section id="about-us" class="features " style="margin-top: 5%;">
	<div class="container" id="i18_about_m">
		...
		<div class="row moto-img text-center"> <!-- first two icons -->
			...
			<div>
				<div class="team-member wow zoomIn animated" style="visibility: visible; animation-name: zoomIn;"><img
							src="images/cultural.gif" height="210"
							width="210"
		...
		<div class="row text-center" style="padding-top:50px";><h4 >TO JOIN CULTURAL CLUB 🧑‍🍳 &nbsp <button class="btn btn-border btn-danger" style=" background-color:purple; color:white; border:none; border-radius:25px;" >REGISTER</button> </h4>
