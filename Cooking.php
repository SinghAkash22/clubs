...
<head>
    ...
    <link rel="stylesheet" href="source/clubstyle.css">
    <script src="https://kit.fontawesome.com/98c9b2a931.js" crossorigin="anonymous"></script>
    <link rel="stylesheet" href="source/timelinestyl.css">
    ...
    <div id="carouselExampleSlidesOnly" class="carousel slide" data-bs-ride="carousel">
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img src="images/cul1.jpg" class="d-block w-100" alt="...">
            </div>
...
<section id="about-us" class="features " style="margin-top: 5%;">
    <div class="container" id="i18_about_m">
        <div class="row m-b-lg  aba">
            ...
            <div class="row moto-img text-center"> <!-- first two icons -->
                ...
                <div>
                    <div class="team-member wow zoomIn animated" style="visibility: visible; animation-name: zoomIn;">
                        <img
                                src="images/cook.gif" height="210"
                                width="210"
                                class="img-responsive img-circle" alt=""><h4><span
                            class="navy">Welecom to</span>
                        Cooking club</h4>
    ...
    <div class="row text-center" style="padding-top:50px" ;>
        <h4>TO JOIN COOKING CLUB 🧑‍🍳 &nbsp
            <button class="btn btn-border btn-danger"
                    style=" background-color:purple; color:white; border:none; border-radius:25px;">REGISTER
            </button>
        </h4>
        <!-- <button class="btn btn-border btn-danger" >REGISTER</button>  -->
    </div>
    </div>
...
<section id="committee" class="features " style="margin-top: 5%;">
    <div class="container" id="i18_about_">
        <div class="col-lg-12 text-center "><h1 class="committee about" style="  margin-bottom: 4%;"><span
                class="committee"
                data-i18n="about_me.about_me">COMMETEE MEMBER OF COOKING CLUB</span>
        </h1>
            <div class="row m-b-lg  aba">
                ...
                <table style="width:100%">
                    ...
                    <td><strong>Noor Siddiqui</strong></td>
                    <td>B.Tech</td>
                    <td>+91 8707527339</td>
                    </tr>
                    <tr>
                        <td><strong>Hemant Singh</strong></td>
                        <td>B.Tech</td>
                        <td>+91 7007377492</td>
                    </tr>
                    <tr>
                        <td><strong>Prerna Sahu</strong></td>
                        <td>B. Tech</td>
                        <td>+91 9198568817</td>
                    </tr>
                    <tr>
                        <td><strong>Puja Singh</strong></td>
                        <td>B.Pharm</td>
                        <td>+91 9076958788</td>
                    </tr>
                </table>
...
<!--<section id="Timeline" class="features " style="margin-top: 5%;">-->
<!--	<div class="container" id="i18_about_me">-->
<!--		<div class="row m-b-lg  aba">-->
<!--			<div class="col-lg-12 text-center "><h5><span  data-i18n="about_me.about_me">Timeline</span>-->
<!--		</h5>-->
<!--				<p> Lorem ipsum dolor sit amet, consectetur adipisicing elit. Ad amet beatae consectetur cum dicta dolorem eaque earum eligendi enim esse ex exercitationem facilis impedit in, ipsa, itaque nobis numquam officia perferendis perspiciatis quos rem repellat reprehenderit repudiandae tenetur unde vel</p>-->
<!--		 </div>-->
<!--		</div>-->
<!--		-->
<!--</section>-->
<section style="background-color: #f4f4f4; margin-top: 7%;">
    <div class="container">
        ...
        <div class="timeline">
            ...
            <div class="section">
                ...
                <div class="content">
                    <h2>Wne</h2>
                    <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Ab eaque esse est fugiat illum ipsa
                        ipsam, iste placeat possimus temporibus.</p>
                </div>
            </div>
            <div class="section">
                <div class="bead">
            ...
            <div class="section">
                <div class="bead"><i class="fa-solid fa-book"></i>
                </div>
                <div class="content">
                    <h2>Wne</h2>
                    <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Ab eaque esse est fugiat illum ipsa
...
<section id="links" class="features contact" style="background-color: #f4f4f4; margin-top: 7%;">
    <div class="container" id="i18_link">
        <div class="row m-b-lg">
            <div class="col-lg-12 text-center"><h1><span data-i18n="link.link">Contact</span></h1></div>
        </div>
        <div class="row">
            <div class="col-sm-4 wow zoomIn" style="visibility: visible; animation-name: zoomIn;">
                <div class="team-member"><h4><span class="navy">Jatin</span> Garg</h4>
                    <p>Joint Secretary</p>
                    <ul class="list-inline social-icon">
                        <li><a href="mailto:jatin.garg.cse19@itbhu.ac.in"><i class="fa fa-envelope-o"></i></a></li>
                    </ul>
                </div>
            </div>
            <div class="col-sm-4 wow zoomIn" style="visibility: visible; animation-name: zoomIn;">
                <div class="team-member"><h4><span class="navy">Lakshya</span> Singh</h4>
                    <p>Secretary</p>
                    <ul class="list-inline social-icon">
                        <li><a href="https://www.manlakshya.tech" target="blank"><i class="fa fa-link"></i></a></li>
                        <li><a href="mailto:lakshya.singh.cse19@itbhu.ac.in"><i class="fa fa-envelope-o"></i></a></li>
                    </ul>
                </div>
            </div>
            <div class="col-sm-4 wow zoomIn" style="visibility: visible; animation-name: zoomIn;">
                <div class="team-member"><h4><span class="navy">Somnath</span> Sendhilk</h4>
                    <p>Joint Secretary</p>
                    <ul class="list-inline social-icon">
                        <li><a href="mailto:somnath.sendhilk.eee19@itbhu.ac.in"><i class="fa fa-envelope-o"></i></a>
                        </li>
                    </ul>
                </div>
            </div>
        ...
        <div class="row text-center" >
            <div class="col-lg-8 col-lg-offset-2 text-center m-t-lg m-b-lg" style="margin: auto"><p id="jalpc_site_pv"><strong>© 2021 CCU
                CSJM(Kanpur)</strong></p></div>
        </div>
    </div>
</section>
